...
export const EngineDiagnosticCode = {
  ...
  PLUGIN_ENGINE_COMPATIBILITY_INVALID: "PLUGIN_ENGINE_COMPATIBILITY_INVALID",
  PLUGIN_ENGINE_COMPATIBILITY_UNDECLARED: "PLUGIN_ENGINE_COMPATIBILITY_UNDECLARED",
  ...
  KERNEL_IDENTITY_INVALID: "KERNEL_IDENTITY_INVALID",
} as const;
