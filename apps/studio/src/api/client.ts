...
import type {
  ...
  VisualPipelineDiff,
  VisualPipelineDraftResponse,
  VisualPipelinePublishResponse,
  VisualPipelineSpec,
  VisualPipelineState,
} from "./types";
...
class LiveStudioApi implements StudioApi {
  ...
  async #request<T>(path: string, init: RequestInit = {}): Promise<T> {
    ...
    try {
      ...
      throw new ApiError(
        ...
        { method, path, correlationId: requestCorrelationId },
      );
    }
    ...
    if (!response.ok) {
      ...
      throw new ApiError(
        ...
        { method, path, correlationId: responseCorrelationId },
      );
    }
    return body as T;
  }
  ...
  listApprovals(status?: ChangeApproval["status"]): Promise<readonly ChangeApproval[]> {
    ...
    return this.#request(`/api/approvals${suffix}`);
  }
  ...
  reviewApproval(
    ...
    return this.#request(`/api/approvals/${encodeURIComponent(id)}/review`, {
      method: "POST",
      headers: { "x-change-reason": reason },
      body: JSON.stringify({ expectedVersion, decision, reason }),
    });
  }
  ...
  listResources(
    query: { readonly kind?: string; readonly status?: ResourceStatus } = {},
  ...
  listResourceRevisions(kind: string, id: string): Promise<readonly Resource[]> {
    return this.#request(
      `/api/resources/${encodeURIComponent(kind)}/${encodeURIComponent(id)}/revisions`,
    );
  }
  ...
  publishResource(
    ...
    return this.#request(
      `/api/resources/${encodeURIComponent(kind)}/${encodeURIComponent(id)}/publish`,
      {
        method: "POST",
        headers: governanceHeaders(changeReason, approvalId),
  ...
  cloneResource(kind: string, id: string, revision?: number): Promise<Resource> {
    return this.#request(
      `/api/resources/${encodeURIComponent(kind)}/${encodeURIComponent(id)}/clone`,
      {
        method: "POST",
  ...
  archiveResource(
    ...
    return this.#request(
      `/api/resources/${encodeURIComponent(kind)}/${encodeURIComponent(id)}/archive`,
      {
        method: "POST",
        headers: governanceHeaders(changeReason, approvalId),
      },
  ...
  saveProjectSourceDraft(
    ...
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/draft/${draftVersion}`,
      {
        method: "PUT",
  ...
  listDraftMaterials(projectId: string): Promise<readonly DraftMaterialCatalogItem[]> {
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/draft/materials`,
    );
  }
  ...
  publishProjectSource(
    ...
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/draft/${draftVersion}/publish`,
      {
        method: "POST",
        headers: governanceHeaders(changeReason, approvalId),
      },
  ...
  listProjectSourceRevisions(
    ...
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/source/revisions`,
    );
  }
  ...
  diffProjectSource(
    ...
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/source/diff?${search.toString()}`,
    );
  }
  ...
  listVisualMaterials(
    ...
    return this.#request(
      `/api/project-builds/${encodeURIComponent(buildId)}/visual-materials`,
      { signal },
    );
  }
  ...
  getVisualPipeline(projectId: string, signal?: AbortSignal): Promise<VisualPipelineState> {
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/visual-pipeline`,
      { signal },
    );
  }
  ...
  validateVisualPipeline(
    ...
    return this.#request(
      `/api/project-builds/${encodeURIComponent(buildId)}/visual-pipelines/validate`,
  ...
  saveVisualPipelineDraft(
    ...
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/visual-pipeline/draft`,
      {
        method: "POST",
        body: JSON.stringify({ buildId, spec, expectedUpdatedAt }),
        signal,
      },
    );
  }
  ...
  diffVisualPipeline(projectId: string, signal?: AbortSignal): Promise<VisualPipelineDiff> {
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/visual-pipeline/diff`,
      { signal },
    );
  }
  ...
  publishVisualPipeline(
    ...
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/visual-pipeline/publish`,
      {
        method: "POST",
        headers: governanceHeaders(changeReason, approvalId),
        body: JSON.stringify({
  ...
  getActiveProjectRelease(projectId: string): Promise<ActiveProjectRelease | null> {
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/active-release`,
    );
  }
  ...
  invokeProjectAction(
    ...
    return this.#request(
      `/api/runtime/${encodeURIComponent(projectId)}/actions/${encodeURIComponent(actionId)}`,
      {
        method: "POST",
  ...
  listProjectReleaseMaterials(
    ...
    return this.#request(
      `/api/code-projects/${encodeURIComponent(projectId)}/releases/${revision}/materials`,
    );
  }
  executeProjectMaterial(
    ...
    return this.#request(
      `/api/runtime/${encodeURIComponent(projectId)}/materials/${encodeURIComponent(materialId)}/${encodeURIComponent(version)}/execute`,
      {
        method: "POST",
