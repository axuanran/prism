...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@prismengine/contracts-governance": pkg("contracts-governance"),
      "@prismengine/contracts-storage": pkg("contracts-storage"),
      "@prismengine/contracts-secret": pkg("contracts-secret"),
      "@prismengine/contracts-worker": pkg("contracts-worker"),
      ...
      "@prismengine/plugin-secret-local": pkg("plugin-secret-local"),
      "@prismengine/plugin-secret-vault": pkg("plugin-secret-vault"),
      "@prismengine/plugin-artifact-store-s3": pkg("plugin-artifact-store-s3"),
      "@prismengine/plugin-audit-export-s3": pkg("plugin-audit-export-s3"),
      "@prismengine/plugin-observability-otel": pkg("plugin-observability-otel"),
      "@prismengine/plugin-governance-approval": pkg("plugin-governance-approval"),
      "@prismengine/plugin-worker-local": pkg("plugin-worker-local"),
      "@prismengine/plugin-worker-container": pkg("plugin-worker-container"),
      ...
      "@prismengine/plugin-studio-api": pkg("plugin-studio-api"),
